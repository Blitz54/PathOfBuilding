...
{ 1, "Charges", 3, colorCodes.NORMAL, {{ defaultCollapsed = true, label = "Charges", data = {
	...
	extra = colorCodes.RAGE.."{0:output:EnduranceCharges} ^7/ "..colorCodes.RAGE.."{0:output:EnduranceChargesMax}",
		...
		{ label = "Chance on Hit", haveOutput = "EnduranceChargeGainOnHit", { format = "{0:output:EnduranceChargeGainOnHit}%", { modName = { "EnduranceChargeGainOnHit" } } }, },
		{ label = "Chance on Kill", haveOutput = "EnduranceChargeGainOnKill", { format = "{0:output:EnduranceChargeGainOnKill}%", { modName = { "EnduranceChargeGainOnKill"} } }, },
		{ label = "On Attack Block", haveOutput = "EnduranceChargeGainOnAttackBlock", { format = "{0:output:EnduranceChargeGainOnAttackBlock}%", { modName = { "EnduranceChargeGainOnBlock", "EnduranceChargeGainOnAttackBlock" } } }, },
		{ label = "On Spell Block", haveOutput = "EnduranceChargeGainOnSpellBlock", { format = "{0:output:EnduranceChargeGainOnSpellBlock}%", { modName = { "EnduranceChargeGainOnBlock", "EnduranceChargeGainOnSpellBlock" } } }, },
		{ label = "Chance when Hit", haveOutput = "EnduranceChargeGainWhenHit", { format = "{0:output:EnduranceChargeGainWhenHit}%", { modName = { "EnduranceChargeGainWhenHit"} } }, },
		{ label = "Chance to Steal", haveOutput = "EnduranceChargesStealOnHit", { format = "{0:output:EnduranceChargesStealOnHit}%", { modName = { "EnduranceChargesStealOnHit", "FrenzyChargeGainOnSpellBlock" } } }, },
	} },
	...
	extra = colorCodes.EVASION.."{0:output:FrenzyCharges} ^7/ "..colorCodes.EVASION.."{0:output:FrenzyChargesMax}",
		...
		{ label = "Chance on Non-Crit", haveOutput = "FrenzyChargeGainOnNonCrit", { format = "{0:output:FrenzyChargeGainOnNonCrit}%", { modName = { "FrenzyChargeGainOnHit", "FrenzyChargeGainOnNonCrit" } } }, },
		{ label = "Chance on Crit", haveOutput = "FrenzyChargeGainOnCrit", { format = "{0:output:FrenzyChargeGainOnCrit}%", { modName = { "FrenzyChargeGainOnHit", "FrenzyChargeGainOnCrit" } } }, },
		{ label = "Chance on Kill", haveOutput = "FrenzyChargeGainOnKill", { format = "{0:output:FrenzyChargeGainOnKill}%", { modName = { "FrenzyChargeGainOnKill" } } }, },
		{ label = "On Attack Block", haveOutput = "FrenzyChargeGainOnAttackBlock", { format = "{0:output:FrenzyChargeGainOnAttackBlock}%", { modName = { "FrenzyChargeGainOnBlock", "FrenzyChargeGainOnAttackBlock" } } }, },
		{ label = "On Spell Block", haveOutput = "FrenzyChargeGainOnSpellBlock", { format = "{0:output:FrenzyChargeGainOnSpellBlock}%", { modName = { "FrenzyChargeGainOnBlock", "FrenzyChargeGainOnSpellBlock" } } }, },
		{ label = "Chance to Steal", haveOutput = "FrenzyChargesStealOnHit", { format = "{0:output:FrenzyChargesStealOnHit}%", { modName = { "FrenzyChargesStealOnHit", "FrenzyChargeGainOnSpellBlock" } } }, },
	} },
	...
	extra = colorCodes.MANA.."{0:output:PowerCharges} ^7/ "..colorCodes.MANA.."{0:output:PowerChargesMax}",
		...
		{ label = "Chance on Non-Crit", haveOutput = "PowerChargeGainOnNonCrit", { format = "{0:output:PowerChargeGainOnNonCrit}%", { modName = { "PowerChargeGainOnHit", "PowerChargeGainOnNonCrit" } } }, },
		{ label = "Chance on Crit", haveOutput = "PowerChargeGainOnCrit", { format = "{0:output:PowerChargeGainOnCrit}%", { modName = { "PowerChargeGainOnHit", "PowerChargeGainOnCrit" } } }, },
		{ label = "Chance on Kill", haveOutput = "PowerChargeGainOnKill", { format = "{0:output:PowerChargeGainOnKill}%", { modName = { "PowerChargeGainOnKill" } } }, },
		{ label = "On Attack Block", haveOutput = "PowerChargeGainOnAttackBlock", { format = "{0:output:PowerChargeGainOnAttackBlock}%", { modName = { "PowerChargeGainOnBlock", "PowerChargeGainOnAttackBlock" } } }, },
		{ label = "On Spell Block", haveOutput = "PowerChargeGainOnSpellBlock", { format = "{0:output:PowerChargeGainOnSpellBlock}%", { modName = { "PowerChargeGainOnBlock", "PowerChargeGainOnSpellBlock" } } }, },
		{ label = "Chance to Steal", haveOutput = "PowerChargesStealOnHit", { format = "{0:output:PowerChargesStealOnHit}%", { modName = { "PowerChargesStealOnHit", "FrenzyChargeGainOnSpellBlock" } } }, },
	} },
} },
-- misc defense
