...
local function doActorCharges(env, actor)
	...
	output.PowerChargeGainOnCrit = m_max(modDB:Sum("BASE", nil, "PowerChargeGainOnHit", "PowerChargeGainOnCrit"), 0)
	output.PowerChargeGainOnNonCrit = m_max(modDB:Sum("BASE", nil, "PowerChargeGainOnHit", "PowerChargeGainOnNonCrit"), 0)
	output.PowerChargeGainOnKill = m_max(modDB:Sum("BASE", nil, "PowerChargeGainOnKill"), 0)
	output.PowerChargeGainOnAttackBlock = m_max(modDB:Sum("BASE", nil, "PowerChargeGainOnBlock", "PowerChargeGainOnAttackBlock"), 0)
	output.PowerChargeGainOnSpellBlock = m_max(modDB:Sum("BASE", nil, "PowerChargeGainOnBlock", "PowerChargeGainOnSpellBlock"), 0)
	output.PowerChargesStealOnHit = m_min(m_max(modDB:Sum("BASE", nil, "PowerChargesStealOnHit"), 0), 100)
	...
	output.FrenzyChargeGainOnCrit = m_max(modDB:Sum("BASE", nil, "FrenzyChargeGainOnHit", "FrenzyChargeGainOnCrit"), 0)
	output.FrenzyChargeGainOnNonCrit = m_max(modDB:Sum("BASE", nil, "FrenzyChargeGainOnHit", "FrenzyChargeGainOnNonCrit"), 0)
	output.FrenzyChargeGainOnKill = m_max(modDB:Sum("BASE", nil, "FrenzyChargeGainOnKill"), 0)
	output.FrenzyChargeGainOnAttackBlock = m_max(modDB:Sum("BASE", nil, "FrenzyChargeGainOnBlock", "FrenzyChargeGainOnAttackBlock"), 0)
	output.FrenzyChargeGainOnSpellBlock = m_max(modDB:Sum("BASE", nil, "FrenzyChargeGainOnBlock", "FrenzyChargeGainOnSpellBlock"), 0)
	output.FrenzyChargesStealOnHit = m_min(m_max(modDB:Sum("BASE", nil, "FrenzyChargesStealOnHit"), 0), 100)
	...
	output.EnduranceChargeGainOnHit = m_max(modDB:Sum("BASE", nil, "EnduranceChargeGainOnHit"), 0)
	output.EnduranceChargeGainOnKill = m_max(modDB:Sum("BASE", nil, "EnduranceChargeGainOnKill"), 0)
	output.EnduranceChargeGainOnAttackBlock = m_max(modDB:Sum("BASE", nil, "EnduranceChargeGainOnBlock", "EnduranceChargeGainOnAttackBlock"), 0)
	output.EnduranceChargeGainOnSpellBlock = m_max(modDB:Sum("BASE", nil, "EnduranceChargeGainOnBlock", "EnduranceChargeGainOnSpellBlock"), 0)
	output.EnduranceChargeGainWhenHit = m_max(modDB:Sum("BASE", nil, "EnduranceChargeGainWhenHit"), 0)
	output.EnduranceChargesStealOnHit = m_min(m_max(modDB:Sum("BASE", nil, "EnduranceChargesStealOnHit"), 0), 100)
